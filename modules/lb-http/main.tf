...
resource "google_compute_target_https_proxy" "default" {
  ...
  ssl_certificates = var.certificate_map == null ? compact(concat(var.ssl_certificates, google_compute_ssl_certificate.default.*.self_link, google_compute_managed_ssl_certificate.default.*.self_link, ), ): null
